...
export default class Login extends Component {
  ...
  render(){
  	return(
  		<ImageBackground source={require("../images/background.jpg")} resizeMode = "stretch" style={{flex:1, alignItems:'center', width:null, height:null, justifyContent:'space-between'}}>
      ...
      <TouchableOpacity onPress={() => this.props.navigation.push('trainer')} style={{backgroundColor:'rgba(226,39,44, 0.5)', flex:1, justifyContent:'center', alignItems:'center'}}><Text style={{color:'#fff', fontSize:12, fontWeight:'700'}}>LOG IN</Text></TouchableOpacity>
